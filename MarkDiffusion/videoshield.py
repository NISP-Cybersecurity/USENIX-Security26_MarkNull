...
with open("/home/nisp/Jie/security26/MarkDiffusion/dataset/vbench/prompts_per_dimension/human_action.txt", 'r', encoding='utf-8') as f:
...
#     save_video_frames(watermarked_video, f"/home/nisp/Jie/security26/Dataset/SVD_VideoShield/video_{i}")
...
# print("avg bit acc:", all_bit_acc/50)
...
print("avg bit acc:", all_bit_acc/len(os.listdir(path)))