...
def seed_everything(seed: int = 42, deterministic: bool = True):
    ...
    if deterministic:
        ...
        # 对某些 CUDA GEMM 可复现性更友好（不保证所有情况都需要）
...
class VideoMarkConfig(BaseConfig):
    ...
    def initialize_parameters(self) -> None:
        ...
        self.shift = 40 #np.random.default_rng().integers(0, self.sequence_length - self.num_frames)
        ...
        #print(self.message_sequence,self.shift,self.message )
